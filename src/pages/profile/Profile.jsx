...
export default function Profile() {
  ...
  return (
    <section className="mx-5 md:container md:mx-auto my-10 md:flex items-center">
      <div className="lg:w-1/2 hidden md:block">
        <img src={img} alt="" />
      </div>
      <div className="lg:w-1/2 shadow rounded p-8">
        ...
        <div className="flex flex-col gap-5 md:flex-row md:justify-between md:gap-8 mt-8">
          ...
          {!edit ? (
            ...
            <form className="flex flex-col gap-2">
              <h1 className="text-[18px] md:text-[22px]">Full Name</h1>
              <input
                className="text-[20px] md:text-[24px] border border-gray-300 focus:outline-blue px-2 py-1 rounded"
                defaultValue={userInfo.name}
              />
              <h1 className="text-[18px] md:text-[22px]">Change Password</h1>
              <input className="text-[20px] md:text-[24px] border border-gray-300 focus:outline-blue px-2 py-1 rounded" placeholder="Current Password" />
              <input className="text-[20px] md:text-[24px] border border-gray-300 focus:outline-blue px-2 py-1 rounded" placeholder="New Password" />
              <input className="text-[20px] md:text-[24px] border border-gray-300 focus:outline-blue px-2 py-1 rounded" placeholder="Confirm Password" />
