    ...
    <section className="mx-5 md:container md:mx-auto my-10">
      ...
      {view === 1 ? (
        <section className="mt-5">
          {courses?.length > 0 ? (
            <div>
              <h1 className="text-[18px] md:text-[24px]">Your invoices courses</h1>
                    ...
                    {courses.map((c, index) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className={classes}>
                            <Link to={`/invoices/${c?.order_id}`} className="bg-blue px-4 py-2 shadow rounded text-white" >View</Link>
                          </td>
                        </tr>
                      );
                    })}
        ...
        <section className="mt-5">
          {services?.length > 0 ? (
            <div>
              <h1 className="text-[18px] md:text-[24px]">Your invoices services</h1>
              <Card className="h-full w-full overflow-scroll mt-5">
                <table className="w-full min-w-max table-auto text-left">
                  <thead>
                    <tr>
