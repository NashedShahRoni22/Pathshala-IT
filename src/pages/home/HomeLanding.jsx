        ...
        <div className="md:w-1/2">
          <div className="flex gap-4 my-4 justify-center items-end">
            <img
              ...
              className="landingImage rounded-xl h-[100px] w-[150px] lg:h-full lg:w-full"
            />
            <img
              src={img}
              alt=""
              ...
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
              className="landingImage rounded-xl h-[200px] w-[140px] lg:h-full lg:w-full"
            />
          </div>
          <div className="flex gap-4 my-4 justify-center items-start">
            <img
              ...
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
              className="landingImage rounded-xl h-[80px] w-[115px] lg:h-full lg:w-full"
            />
            <img
              src={img4}
              alt=""
              ...
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
              className="landingImage rounded-xl h-[160px] w-[220px] lg:h-full lg:w-full"
            />
          </div>
        </div>
      </div>
