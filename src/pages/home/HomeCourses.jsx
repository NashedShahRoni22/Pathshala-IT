...
import img from "../../assets/icons/CourseImage.png";
    ...
    <section className="">
      <div className="mx-5 md:container md:mx-auto">
        ...
        <p className="text-[16px] text-center">
          ...
          skills. <br />
          The knowledge, experience, and expertise gained through the program
          will ensure your desired job in the global market.
        </p>
