  ...
  const data = [
    {
      ...
      teamData: [
        {
          img: teamPerson,
          name: "Md Motiur Rahman Munna",
          designation: "Founder & CEO",
        },
        {
          img: teamPerson,
          name: "Mohammad Abdul Mottaleb",
        ...
        },
        {
          img: teamPerson,
          name: "Shuvo Ahmed",
          designation: "Wordpress Theme customize Expert",
        },
        {
          img: teamPerson,
          name: "K.m Shafiqul Islam ",
          designation: "Digital Marketer & Supply Chain Expert",
        },
        {
          img: teamPerson,
          name: "Md. Jihad Sarker",
